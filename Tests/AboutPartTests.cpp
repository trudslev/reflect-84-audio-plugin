...
/**
    ...
    **The PNGs are the point of writing them at all.** A layer that is drawn, correct and invisible
    passes every assertion here: the About tab was under `panelBackground` for one build, because
    JUCE paints children in the order they are added and the tab was registered beside its
...
public:
    ...
    void runTest() override
    {
        ...
        auto* editor = dynamic_cast<Reflect84AudioProcessorEditor*> (processor.createEditor());
        ...
        /*  §4's minimum. This casting is the SHORTEST of the six at 648, so if any canvas fails the
            law it is this one — which is why the assertion lives here rather than only in core. */
        ...
        expect (nf::AboutBox::repositoryFits ("github.com/trudslev/reflect-84-audio-plugin"),
        ...
        expect (nf::testing::writeComponentPng (*content, dir.getChildFile ("reflect-84-rest.png")),
